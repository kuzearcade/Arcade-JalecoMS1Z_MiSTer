...
MS1-Z: the core runs one game, and it has only two buttons, so Autofire's
"button 3 becomes a plain button 1" trade costs nothing. Both sets get a
copy (the clone through its `_alternatives/_Legend of Makai` directory).
...
# "Legend of Makai (World).mra" and the clone directory "_Legend of Makai"
# both qualify from one entry -- the directory name drops the parenthetical,
# the file name keeps it.
#
INCLUDED = (
    "Legend of Makai",
)
