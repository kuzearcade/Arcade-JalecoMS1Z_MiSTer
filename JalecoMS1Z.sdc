# Jaleco Mega System 1-Z timing constraints. Derived from JalecoMS1BCD.sdc;
# the TLCS-90 multicycle island is gone with the protection MCU.
#
...
# Core clock groups
# ------------------------------------------------------------------
# The game logic (68000, Z80, YM2203, video) runs on clk_sys at 48 MHz and
